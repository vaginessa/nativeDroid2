...
(function ($) {
    $.nd2Search = function (options) {
        ...
        _self.bindEvents = function () {
            _self.getHeader().on('click', '.nd2-search-button', function (e) {
                e.preventDefault();
        ...
        _self.bindAutocomplete = function () {
            ...
            _self.getSearchInputObj().autocomplete({
                ...
                return $("<li class='nd2-search-result-item'>").attr("data-value", item.value).append("<span class='icon'>" + icon + "</span><span class='term'>" + item.label + "</span>").appendTo(ul);
            };
        };
